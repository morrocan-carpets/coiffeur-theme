...
(function($) {
  ...
  function LASFAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  LASFAjaxChosen.prototype.init = function() {
  ...
  LASFAjaxChosen.prototype.events = function() {
  ...
  LASFAjaxChosen.prototype.search_field_focused = function() {
  ...
  LASFAjaxChosen.prototype.search_welcome_message = function() {
  ...
  LASFAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('lasf-chosen', _this.options.data).done( function( response ) {
  ...
  LASFAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.lasf-hidden-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.LASFChosenOrder($hidden_value, true);
  ...
  $.fn.LASFAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new LASFAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, LASFAbstractChosenOrder, _ref,
      __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
      __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  LASFAbstractChosenOrder = (function() {

    function LASFAbstractChosenOrder() {}

    LASFAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    LASFAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    LASFAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    LASFAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    LASFAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    LASFAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    LASFAbstractChosenOrder.LASFChosenOrder = function(select, order, force) {
    ...
    return LASFAbstractChosenOrder;
  ...
  $.fn.extend({
    LASFChosenOrder: function(order, force) {
      return _LASFChosenOrder.LASFChosenOrder(this, order, force);
    }
  });

  this._LASFChosenOrder = (function(_super) {
    __extends(_LASFChosenOrder, _super);

    function _LASFChosenOrder() {
      _ref = _LASFChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _LASFChosenOrder.relAttributeName = 'data-option-array-index';

    _LASFChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _LASFChosenOrder.getDOMElement = function(element) {
    ...
    _LASFChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _LASFChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _LASFChosenOrder;

  })(LASFAbstractChosenOrder);
