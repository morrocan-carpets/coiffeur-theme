...
class LaStudio_Swatch_Term {
    ...
    public function get_output( $product_url = '#', $data_thumb = '', $placeholder = true, $placeholder_src = 'default' ) {
        ...
        $html_output = '<div data-thumb="'.esc_attr($data_thumb).'" class="' . esc_attr(implode(' ', $html_class_wrap )) . '" data-attribute="' . esc_attr($this->taxonomy_slug) . '" data-title="'.esc_html($this->term_label).'" data-value="' . esc_attr( $this->term_slug ) . '">';
